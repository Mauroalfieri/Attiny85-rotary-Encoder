...
void loop() {
    byte numLed = (currentValue*NUMPIXELS/64);
    byte loop_n = (numLed/NUMPIXELS);

    for(int i=0;i<numLed;i++) { pixels.setPixelColor(i, Wheel(((loop_n * 256 / NUMPIXELS) + currentValue) & 255)); }
